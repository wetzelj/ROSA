...
namespace RosaTEST
{
	...
	public delegate bool EnumWindowsProc(IntPtr hWnd, ref WindowObjInfo data);
	/// <summary>
	...
	public class WinAPI
	{
		...
		[return: MarshalAs(UnmanagedType.Bool)]
		public static extern bool EnumWindows(EnumWindowsProc lpEnumFunc, ref WindowObjInfo data);
